...
public class moneytransTest {
    ...
    public void phone_check1() {
        String result;
        if(moneytrans.phone_check("1234567890"))
            result="Valid";
        else
            result="Invalid";
    ...
    public void phone_check2() {
        String result;
        if(moneytrans.phone_check("2245634989"))
            result="Valid";
        else
            result="Invalid";
    ...
    public void phone_check3() {
        String result;
        if(moneytrans.phone_check("9024563489"))
            result="Valid";
        else
            result="Invalid";
        assertThat(result,is(FAIL_STRING));
    ...
    public void phone_check4() {
        String result;
        if(moneytrans.phone_check("224563t989"))
            result="Valid";
        else
            result="Invalid";
        assertThat(result,is(FAIL_STRING));
    ...
    public void phone_check5() {
        String result;
        if(moneytrans.phone_check("224563345989"))
            result="Valid";
        else
            result="Invalid";
        assertThat(result,is(FAIL_STRING));
    ...
    public void phone_check6() {
        String result;
        if(moneytrans.phone_check("9224563489"))
            result="Valid";
        else
            result="Invalid";
        assertThat(result,is(FAKE_STRING));
    ...
    public void upi_check1() {
        String result;
        if(moneytrans.upi_check("word@word"))
            result="Valid";
        else
            result="Invalid";
        assertThat(result,is(FAKE_STRING));
    ...
    public void upi_check2() {
        String result;
        if(moneytrans.upi_check("123@word"))
            result="Valid";
        else
            result="Invalid";
        assertThat(result,is(FAKE_STRING));
    ...
    public void upi_check3() {
        String result;
        if(moneytrans.upi_check("123@123"))
            result="Valid";
        else
            result="Invalid";
        assertThat(result,is(FAKE_STRING));
    ...
    public void upi_check6() {
        String result;
        if(moneytrans.upi_check("word@123"))
            result="Valid";
        else
            result="Invalid";
        assertThat(result,is(FAKE_STRING));
    ...
    public void upi_check8() {
        String result;
        if(moneytrans.upi_check("word@word@word"))
            result="Valid";
        else
            result="Invalid";
        assertThat(result,is(FAIL_STRING));
